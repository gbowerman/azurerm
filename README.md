...
There is a more complete list of **azurerm** programming examples here: <a href="https://github.com/gbowerman/azurerm/blob/master/examples.md">azurerm Python library programming examples</a>.
