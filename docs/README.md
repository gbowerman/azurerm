...
Generated by [py2md](https://github.com/gbowerman/py2md) on 2019-04-18 14:24:39 
...
8. [graphfns - functions to call Microsoft graph functions](#graphfns---functions-to-call-microsoft-graph-functions)
9. [insightsrp.py - azurerm functions for the Microsoft.Insights resource provider](#insightsrppy---azurerm-functions-for-the-microsoftinsights-resource-provider)
10. [keyvault.py - azurerm functions for the Microsoft.Keyvault resource provider](#keyvaultpy---azurerm-functions-for-the-microsoftkeyvault-resource-provider)
11. [networkrp.py - azurerm functions for the Microsoft.Network resource provider](#networkrppy---azurerm-functions-for-the-microsoftnetwork-resource-provider)
12. [resourcegroups.py - azurerm functions for Resource Groups.](#resourcegroupspy---azurerm-functions-for-resource-groups)
13. [azurerm restfns - REST functions for azurerm](#azurerm-restfns---rest-functions-for-azurerm)
14. [settings.py - place to store constants for azurerm](#settingspy---place-to-store-constants-for-azurerm)
15. [storagerp.py - azurerm functions for the Microsoft.Storage resource provider](#storagerppy---azurerm-functions-for-the-microsoftstorage-resource-provider)
16. [subnfs - place to store azurerm functions related to subscriptions](#subnfs---place-to-store-azurerm-functions-related-to-subscriptions)
17. [templates.py - azurerm functions for deploying templates](#templatespy---azurerm-functions-for-deploying-templates)
18. [vmimages.py - azurerm functions for Microsoft.Compute RP publishers and images](#vmimagespy---azurerm-functions-for-microsoftcompute-rp-publishers-and-images)
...
### list_contentkey_authorization_policy_options
...
### delete_contentkey_authorization_policy
...
[source file](../azurerm/graphfns.py)
...
### set_keyvault_secret
set_keyvault_secret(access_token, vault_uri, secret_name, secret_value)
...
delete_keyvault_secret(access_token, vault_uri, secret_name)
