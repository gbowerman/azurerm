...
from .computerp      import delete_vm, get_vm, list_vms, restart_vm, start_vm, stop_vm, deallocate_vm, delete_vm_scale_set, delete_vmss_vm, list_vm_scale_sets, list_vmss_vms
