...
from .computerp      import delete_vm, get_vm, list_vms, restart_vm, start_vm, stop_vm, deallocate_vm, get_vm_extension, delete_vm_scale_set, delete_vmss_vms, get_vmss, get_vmss_instance_view, list_vm_scale_sets, list_vmss_vms, get_vmss_vm, get_vmss_vm_instance_view, get_vmss_nics, get_vmss_vm_nics, start_vmss, stopdealloc_vmss, start_vmss_vms, stopdealloc_vmss_vms, restart_vmss, restart_vmss_vms, poweroff_vmss, poweroff_vmss_vms, scale_vmss, get_compute_usage
