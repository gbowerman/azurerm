...
print_phase_header("Getting the Media Processor for Face Detection")
...
if (MODE == "Face"):
	print_phase_header("Creating a Face Detection Job to process the content")
	with open(FACE_DETECTION_CONFIG, mode='r') as file:
			configuration = file.read()
elif (MODE == "Emotion"):
	print_phase_header("Creating an Emotion Detection Job to process the content")
...
if (response.status_code == 200):
	...
	print_phase_message("GET Status..............................: " + str(response.status_code))
	print_phase_message("Indexed Media Asset Id..................: " + face_asset_id)
else:
